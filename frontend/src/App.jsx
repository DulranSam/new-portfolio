  ...
  return (
    <>
      <div className="container" id="container">
        ...
        <br></br>
        <section
          className={`hidden ${isVisible ? "is-visible" : ""}`}
          ref={domRef}
        >
          <div className="upper" id="home">
            ...
            <label>
              <p style={{ fontSize: "x-large" }}>
                18 Year Old Undergraduate FullStack Web Developer/Enthusiast
        ...
        >
          <div className="middle" id="projects">
            <h1 style={{ fontSize: "xx-large" }}>Projects</h1>
            <br></br>
            <p style={{ fontSize: "x-large" }}>
              I'm a 2nd year CS Student at
              <a href="https://www.iit.ac.lk/"> IIT</a>. Currently my projects
              are small scale ones. however with experience I do intend on
              moving onto larger projects. I have beginner/intermediate level of
              working experience with the MERN stack and recently got started
              with Flutter and Tailwind CSS.
            </p>
            <br></br>
            <label>
            ...
            <div className="projects">
              ...
              <div className="card">
                <label>
                  ...
                  <p>
                    ...
                    CRUD operations to the Cluster (MongoDB) , where I also
                    gained a lot of knowledge on how to work with ReactJS
                  </p>
                </label>
              </div>
              <div className="card">
                <label>
                  ...
                  <p>
                    Project created using the MERN stack , to make CRUD
                    operations from the frontend to handle appropriately
                    <a href="yts.am">YTS</a>
                  </p>
                </label>
              </div>
              <div className="card">
                <label>
                  ...
                  <p>
                    ...
                    Using a free api provided by{" "}
                    <a href="https://yts.mx/">YTS</a>
                  </p>
                </label>
              </div>
              <div className="card">
              ...
              <div className="card">
                <label>
                  ...
                  <p>
                    Mini Side Project created using Chat-GPT's api ,
                    specifically to make a post request for frontend requests to
                    generate number of ai images requested by user
                  </p>
              ...
              <div className="card">
                <label>
                  ...
                  <p>
                    Created using <a href="https://www.coinapi.io/">Coin Api</a>
                  </p>
        ...
        >
          <div className="bottom">
            <h1 style={{ fontSize: "xx-large" }}>Currently</h1>
            <br></br>
            <p style={{ fontSize: "x-large" }}>
